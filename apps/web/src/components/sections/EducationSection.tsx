        ...
        <section id="education" ref={ref} className="py-20 relative">
            <div className="max-w-6xl mx-auto px-6">
                <motion.div initial={{ opacity: 0, y: 50 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="text-center mb-16">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">Continuous learning is key to staying current in technology</p>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-8">
                            {education.map((edu, index) => (
                                <motion.div key={`${edu.institution}-${index}`} initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}}
                                            ...
                                            className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-500">
                    ...
                    <motion.div initial={{ opacity: 0, x: 50 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.5, duration: 0.8 }}>
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Courses & Certifications</h3>
                        </div>
                        ...
                        <div className="grid gap-4">
                            {courses.map((course, index) => (
                                <motion.div key={course} initial={{ opacity: 0, x: 20 }} animate={inView ? { opacity: 1, x: 0 } : {}}
                                            ...
                                            className="flex items-center gap-4 p-4 bg-gray-100/80 dark:bg-gray-800/30 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-lg hover:border-purple-500/50 hover:bg-purple-500/5 transition-all duration-300">

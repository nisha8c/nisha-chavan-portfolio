        ...
        <section id="experience" className="py-20 relative">
            <div className="max-w-6xl mx-auto px-6">
                <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8 }} className="text-center mb-16">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">My journey through different companies and roles in frontend development</p>
                </motion.div>
                ...
                <div className="relative">
                    ...
                    {(experiences ?? []).map((exp, index) => (
                        ...
                        >
                            <motion.div className="absolute left-8 md:left-1/2 transform md:-translate-x-1/2 w-4 h-4 bg-blue-500 rounded-full border-4 border-gray-50 dark:border-gray-900 z-10"
                            ...
                            <div className={`ml-16 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:ml-0' : 'md:ml-auto'}`}>
                                <motion.div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300"
